...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		logoBl.updateHitbox();
		logoBl.screenCenter();
		FlxTween.linearMotion(logoBl, logoBl.x, logoBl.y, logoBl.x, logoBl.y - 50, 100, false, { ease: FlxEase.smoothStepInOut, type: FlxTweenType.PINGPONG });
	...
	function createCoolText(textArray:Array<String>, ?offset:Float = 0)
	{
		for (i in 0...textArray.length)
		{
			...
			money.setFormat("Sonic Advanced 2 Regular", 48, FlxColor.WHITE, CENTER);
	...
	function addMoreText(text:String, ?offset:Float = 0)
	{
		if(textGroup != null && credGroup != null) {
		    ...
		    coolText.setFormat("Sonic Advanced 2 Regular", 48, FlxColor.WHITE, CENTER);
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 16:
					addMoreText('KSides'); // credTextShit.text += '\nKSides';
