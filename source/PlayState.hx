...
class PlayState extends MusicBeatState
{
	...
	var timeTxt:FlxText;
	var whattimeTxt:FlxText;
	var scoreTxtTween:FlxTween;
	var fazbarWindowNames:Array<String> = ['GOES HARD','BETTER THAN SASTERS SONGS ONG'];
	var foolsWindowNames:Array<String> = ['GOES HARD','BETTER THAN SASTERS SONGS ONG'];
	...
	override public function create()
	{
		...
		{
			case 'fazbars':
				var whatthefuck:FlxText = new FlxText(12, FlxG.height - 0, 0, "kill yourself" + CoolSystemStuff.getUsername(), 12);
		        whatthefuck.setFormat(Paths.font("vc.ttf"), 16, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.WHITE);
		        add(whatthefuck);
		}
		...
		switch (curStage)
		{
            ...
            case 'fazbars': //best song
				var bg:BGSprite = new BGSprite('Fedde', -600, -200, 0.9, 0.9);
				add(bg);
		...
		if (isStoryMode && !seenCutscene)
		{
			switch (daSong)
			{
				...
				case 'fazbars':
				Application.current.window.title = fazbarWindowNames[new FlxRandom().int(0, fazbarWindowNames.length - 1)];
	...
	override function stepHit()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			case 'bopeebo':
				...
				{
					case 1:
						PlatformUtil.sendWindowsNotification("I know your current location", "start running");
				}
		}
	}
